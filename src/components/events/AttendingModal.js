...
import { addAttending, removeAttending } from "../../features/actions/attendingActions";
  ...
  return (
    <Backdrop onClick={handleClose}>
      <motion.div
        ...
        className=" min-w-[90%] min-h-[400px] md:min-w-[400px] md:right-10 border rounded-2xl p-2 md:p-3 flex flex-col items-start content-start fixed bg-white border gap-2"
      >
        {/* close button */}
